...
class coacher_signature : Fragment() {
  ...
  override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
    ...
    val signaturePad = v.findViewById<SignaturePad>(R.id.signaturePad)
    val btnclear = v.findViewById<Button>(R.id.btnclear)
    val btnSave = v.findViewById<Button>(R.id.btnSave)
//    var ivsignature = v.findViewById<ImageView>(R.id.ivsignature)
...
//        arguments!!.getString("remarks12") != null ||
        ...
        arguments!!.getString("firstgrade") != null ||
        arguments!!.getString("secondgrade") != null ||
        arguments!!.getString("finalgrading") != null
...
//      var remarks12 = arguments!!.getString("remarks12")
      ...
      var firstgrade = arguments!!.getString("firstgrade")
      var secondgrade = arguments!!.getString("secondgrade")
      var finalgrading = arguments!!.getString("finalgrading")
...
//          bundle.putString("remarks12", getremarks12)
          ...
          bundle.putString("firstgrade", getfirstgrade)
          bundle.putString("secondgrade", getsecondgrade)
          bundle.putString("finalgrading", getfinalgrade)
