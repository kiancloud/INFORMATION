 ...
 * Use the [coached_dmcssignature.newInstance] factory method to
 * create an instance of this fragment.
 */
class coached_dmcssignature : Fragment() {
    ...
    override fun onCreateView(
        ...
        var v: View = inflater.inflate(R.layout.fragment_coached_dmcssignature, container, false)

        val signaturePad2 = v.findViewById<SignaturePad>(R.id.signaturePad2coachedddmcs)
        val btnclear2 = v.findViewById<Button>(R.id.btnclear2coachedddmcs)
        val btnSave2 = v.findViewById<Button>(R.id.btnSave2coachedddmcs)
        val finalremarksdmcs = v.findViewById(R.id.et_finalremarksdmcs) as EditText
...
//                val file = File(Environment.getExternalStorageDirectory(), "/Evaluation Folder/COACHING LOG.xls")
                ...
                createPDFOM(linenamepdf = getlinename, linepositionpdf = getlineposition,
                    ...
                    ratingrow11 = getrating11, feedbackrow11 = getremarks11, ratingrow12 = getrating12, feedbackrow12 = getremarks12,
                    ratingrow13 = getrating13, feedbackrow13 = getremarks13,ratingrow14 = getrating14, feedbackrow14 = getremarks14,
                    ratingrow15 = getrating15, feedbackrow15 = getremarks15,
//                    ratingrow16 = getrating16, feedbackrow16 = getremarks16,
                    signature1 = coach, signature2 = coachee, finalremarksdmcs = finalremarksdmcs.text.toString())
//// ++++++++++++++++++++++++END CREATE PDF +++++++++++++++++++++++++++++++++++++++++++++++++++++
//
...
//                    ratingrow16: String, feedbackrow16: String,
                    signature1:Bitmap, signature2:Bitmap, finalremarksdmcs: String) {
...
//         SETTING TABLE CELL
        ...
        tableheader.addCell(com.itextpdf.layout.element.Cell().setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(8f).add(Paragraph(salespositionpdf)))
        tableheader.addCell(com.itextpdf.layout.element.Cell().setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(8f).add(Paragraph(salesnamepdf).setBorder(Border.NO_BORDER)))
        tableheader.addCell(com.itextpdf.layout.element.Cell(2, 4).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setBorder(Border.NO_BORDER).addStyle(Style().setBold()).setFontSize(14f).setTextAlignment(
            TextAlignment.CENTER).add(Paragraph("Compentency Developement Plan (Field Coaching Form)")))
        tableheader.addCell(com.itextpdf.layout.element.Cell().setFontSize(8f).add(Paragraph("Date of Coaching:")))
        tableheader.addCell(com.itextpdf.layout.element.Cell().setFontSize(8f).add(
            Paragraph(datepdf).setBorder(
                Border.NO_BORDER)))
        tableheader.addCell(com.itextpdf.layout.element.Cell(1, 7).setFontSize(6f).add(
            Paragraph("Functional Competency and Observation Behaviors " +
...
//         TABLE COLUMN
        table.addCell(com.itextpdf.layout.element.Cell(1, 2).setVerticalAlignment(VerticalAlignment.MIDDLE).addStyle(
            Style().setBold()).setFontSize(11f).setMinWidth(120f).add(Paragraph("COMPETENCY DEVELOPMENT PLAN"))).setTextAlignment(
            TextAlignment.CENTER)
        table.addCell(com.itextpdf.layout.element.Cell().setVerticalAlignment(VerticalAlignment.MIDDLE).addStyle(
            Style().setBold()).setMinWidth(250f).setFontSize(9f).add(Paragraph("COMPETENCIES DESCRIPTION")))
        table.addCell(com.itextpdf.layout.element.Cell().setVerticalAlignment(VerticalAlignment.MIDDLE).addStyle(
            Style().setBold()).setFontSize(9f).add(Paragraph("Company Required Competency Level (RIGHT PEOPLE)"))).setProperty(
            Property.SPLIT_CHARACTERS, DefaultSplitCharacters()
        )
        table.addCell(com.itextpdf.layout.element.Cell().setVerticalAlignment(VerticalAlignment.MIDDLE).addStyle(
            Style().setBold()).setFontSize(9f).add(Paragraph("RATING")))
        table.addCell(com.itextpdf.layout.element.Cell().setVerticalAlignment(VerticalAlignment.MIDDLE).addStyle(
            Style().setBold()).setFontSize(9f).add(Paragraph("COACH/LM OBSERVATION NOTES")))
//         TABLE ROW (1ST ROW)
        table.addCell(com.itextpdf.layout.element.Cell(3, 2).setVerticalAlignment(VerticalAlignment.MIDDLE).addStyle(
            Style().setBold()).setFontSize(8f).add(Paragraph("MINDSET AND BEHAVIOR")))
        table.addCell(com.itextpdf.layout.element.Cell().setVerticalAlignment(VerticalAlignment.MIDDLE).setMinHeight(25f).setFontSize(5f).add(
            Paragraph("LEARNING AGILITY (WILLINGNESS TO LEARN AND ACCEPT QUICKLY)")
        ))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("HD")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(ratingrow1)))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(feedbackrow1)))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("RIGHT M&B WITH SELF: PASSION TO MAKE A DIFFERENCE AND DELIVER RESULTS (MASIPAG, MATIYAGA, DISCIPLINED, COMMITED)")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("HD")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(ratingrow2)))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(feedbackrow2)))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("RIGHT M&B WITH OTHERS: HIGHLY ENGAGES, PRO-ACTIVE/ INITIATES, SERVICE-ORIENTED, SEEKS FIRST TO UNDERSTAND THEN TO BE UNDERSTOOD, THINKS WIN-WIN ")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("HD")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).setFontSize(5f).add(Paragraph(ratingrow3)))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(feedbackrow3)))

//         TABLE ROW (2ND ROW)
        table.addCell(com.itextpdf.layout.element.Cell(1, 2).setVerticalAlignment(VerticalAlignment.MIDDLE).addStyle(
            Style().setBold()).setFontSize(8f).add(Paragraph("FUNCTIONAL COMPETENCY")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("MASTERY OF A DMCS DIAL (DAILY IN A LIFE)")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("CL4")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(ratingrow4)))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(feedbackrow4)))

//         TABLE CELL SEPARATOR
        table.addCell(com.itextpdf.layout.element.Cell(1, 6))

//         TABLE ROW/COLUMN FOR PLAN DO CHECK AND ACT
        table.addCell(com.itextpdf.layout.element.Cell(10, 1).setVerticalAlignment(VerticalAlignment.BOTTOM).setRotationAngle(33F).addStyle(
            Style().setBold()).setFontSize(12f).add(Paragraph("OBSERVABLE BEHAVIORS RELATED TO FUNCTIONAL COMPETENCY")))

//         TABLE ROW (3RD ROW)
        table.addCell(com.itextpdf.layout.element.Cell(3, 1).setVerticalAlignment(VerticalAlignment.MIDDLE).addStyle(
            Style().setBold()).setFontSize(8f).setMinWidth(100f).add(Paragraph("PLAN")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("CONSISTENT AND ACCURATE FILLING OUT OF CHECK AND ACT FORM, LOGGING OBSERVATION AND ACTION PLANS PER CATEGORY DURING STORE VISITS.")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("CL4")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(ratingrow6)))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(feedbackrow6)))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("CREATES A COMMERCIAL PROPOSAL USING THE CONTEXT-INSIGHT-SOLUTION-ACTION(CISA) IN THE SELL FRAMEWORK WHEN SELLING CYCLY PLAN, CUSTOMER-SPECIFIC ACTIVITIES OR CHANNEL PROGRAMS.")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("CL4")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(ratingrow7)))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(feedbackrow7)))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("CREATES A PROPOSAL TO MAXIMIZE VALUE FOR THE COMPANY BY EVALUATING AND ANTICIPATING VARIABLES TO BE TRADED WHEN THERE IS A NEED FOR NEGOTIATION")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("CL4")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(ratingrow8)))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(feedbackrow8)))

//         TABLE ROW (4TH ROW)
        table.addCell(com.itextpdf.layout.element.Cell(4, 1).setVerticalAlignment(VerticalAlignment.MIDDLE).addStyle(
            Style().setBold()).setFontSize(8f).add(Paragraph("DO")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("CONSISTENTLY AND EFFECTIVELY FOLLOWS/EXECUTES D.I.A.L. AND M.I.A.L. ACTIVITIES")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("CL4")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(ratingrow9)))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(feedbackrow9)))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("ABLE TO APPLY QUESTIONING AND LISTENING TECHNIQUES AND APPLIES LPDO IN HANDLING OBJECTIONS")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("CL4")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(ratingrow10)))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(feedbackrow10)))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(VerticalAlignment.MIDDLE)
            .setFontSize(5f).add(Paragraph("UTILIZES THE EFFECTIVE PRESENTATION AND SELLING AND NEGO WORKSHEETS (WHEN APPLICABLE) AS A PREPARATION PRIOR TO CUSTOMER ENGAGMENTS.")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(VerticalAlignment.MIDDLE)
            .setFontSize(5f).add(Paragraph("CL4")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(VerticalAlignment.MIDDLE)
            .setFontSize(5f).add(Paragraph(ratingrow11)))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(VerticalAlignment.MIDDLE)
            .setFontSize(5f).add(Paragraph(feedbackrow11)))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(VerticalAlignment.MIDDLE)
            .setFontSize(5f).add(Paragraph("CONSISTENT AND EFFECTIVE DOING POST-CALL AND END-OF-DAY ANALYSIS IN REFERENCE TO D.I.A.L.")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(VerticalAlignment.MIDDLE)
            .setFontSize(5f).add(Paragraph("CL4")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(VerticalAlignment.MIDDLE)
        ...
        //         TABLE ROW (5TH ROW)
        table.addCell(com.itextpdf.layout.element.Cell(3, 1).setVerticalAlignment(VerticalAlignment.MIDDLE).addStyle(Style().setBold()).setFontSize(8f).add(Paragraph("CHECK AND ACT")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("PERIODICALLY CONDUCTS BUSINESS REVIEWS MEASURING SCORECARD OF KPI'S AGREED WITH CUSTOMER AND ABLE TO IDENTIFY OPPORTUNITES FOR GROWTH AND EFFICIENCIES")))
        ...
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("ANALYSES MTD ACHIEVEMENT AND TRENDS, CREATES EFFECTIVE ACTIONS WITH SET TIMELINE, AND TIMELY ESCALATES ISSUES TO LINE MANAGER.")))
        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph("CL4")))
...
//        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
//            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(ratingrow16)))
//        table.addCell(com.itextpdf.layout.element.Cell().setMinHeight(25f).setVerticalAlignment(
//            VerticalAlignment.MIDDLE).setFontSize(5f).add(Paragraph(feedbackrow16)))

//         TABLE CELL SEPARATOR
        table.addCell(com.itextpdf.layout.element.Cell(1, 6))

        //    FINAL REMARKS
        table.addCell(com.itextpdf.layout.element.Cell().setBorder(Border.NO_BORDER).addStyle(Style().setBold()).setMinHeight(25f).setFontSize(7f).add(
            Paragraph("Remarks:")
        ))
        table.addCell(com.itextpdf.layout.element.Cell(1,2).setBorder(Border.NO_BORDER).setVerticalAlignment(
            VerticalAlignment.MIDDLE).setTextAlignment(TextAlignment.LEFT).setMinHeight(25f).setFontSize(7f).add(
            Paragraph("$finalremarksdmcs.")
        ))
...
//         SIGNATURE NAME
        table.addCell(com.itextpdf.layout.element.Cell(1, 2,).setBorder(Border.NO_BORDER).setVerticalAlignment(
            VerticalAlignment.BOTTOM).setTextAlignment(TextAlignment.LEFT).setMinHeight(15f).addStyle(
            Style().setUnderline()).setFontSize(10f).add(Paragraph(linenamepdf)))
        table.addCell(com.itextpdf.layout.element.Cell().setBorder(Border.NO_BORDER).setMinHeight(15f))
        table.addCell(com.itextpdf.layout.element.Cell(1, 3).setBorder(Border.NO_BORDER).setVerticalAlignment(
            VerticalAlignment.BOTTOM).setTextAlignment(TextAlignment.LEFT).setMinHeight(15f).addStyle(
            Style().setUnderline()).setFontSize(10f).add(Paragraph(salesnamepdf)))
//         SIGNATURE POSITION
        table.addCell(com.itextpdf.layout.element.Cell(1, 2).setBorder(Border.NO_BORDER).setVerticalAlignment(
            VerticalAlignment.TOP).setTextAlignment(TextAlignment.LEFT).setMinHeight(15f).setFontSize(10f).add(
            Paragraph(linepositionpdf)
        ))
        table.addCell(com.itextpdf.layout.element.Cell().setBorder(Border.NO_BORDER).setMinHeight(15f))
        table.addCell(com.itextpdf.layout.element.Cell(1, 3).setBorder(Border.NO_BORDER).setVerticalAlignment(
            VerticalAlignment.BOTTOM).setTextAlignment(TextAlignment.LEFT).setMinHeight(15f).setFontSize(10f).add(
